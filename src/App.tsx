...
import { ChevronDown, Database, Lock, Network, PlayCircle, Shield, Sparkles } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-400 mb-8">
              Revolutionizing distributed machine learning with blockchain-powered data validation and security
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-gray-900/50 border-purple-500/20">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold mb-2 text-white">Privacy Protection</h3>
                <p className="text-gray-400">Ensure data privacy while contributing to the global model through secure blockchain validation.</p>
              </CardContent>
            </Card>
            <Card className="bg-gray-900/50 border-purple-500/20">
              <CardContent className="p-6">
                <Network className="w-12 h-12 text-purple-400 mb-4" />
                <h3 className="text-xl font-bold mb-2 text-white">Distributed Learning</h3>
                <p className="text-gray-400">Enable multiple nodes to contribute to model training while maintaining data sovereignty.</p>
              </CardContent>
            </Card>
            <Card className="bg-gray-900/50 border-purple-500/20">
              <CardContent className="p-6">
                <Database className="w-12 h-12 text-purple-400 mb-4" />
                <h3 className="text-xl font-bold mb-2 text-white">Data Integrity</h3>
                <p className="text-gray-400">Validate and verify data contributions through immutable blockchain records.</p>
              </CardContent>
            </Card>
          </div>
        </div>
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Every data contribution is secured and validated through blockchain technology.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Automated validation of data quality and integrity before model updates.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Distributed nodes working together to improve the main model.</p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-8">
              Interested in implementing secure federated learning for your organization? Let's talk about how we can help.
            </p>
